...
ActiveRecord::Schema.define(version: 20160422180425) do
  ...
  create_table "arena_blobs", primary_key: "blob_id", force: true do |t|
    t.uuid     "guid"
    t.datetime "date_created"
    t.datetime "date_modified"
    t.string   "created_by",         limit: nil
    t.string   "modified_by",        limit: nil
    t.string   "file_ext",           limit: nil
  ...
  create_table "arena_notes", primary_key: "person_history_id", force: true do |t|
    t.datetime "date_created"
    t.datetime "date_modified"
    t.string   "created_by"
    t.string   "modified_by"
  ...
  create_table "arena_prayer_requests", primary_key: "request_id", force: true do |t|
    t.datetime "date_created"
    t.datetime "date_modified"
    t.string   "created_by"
    t.string   "modified_by"
